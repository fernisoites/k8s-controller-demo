...
import (
	...
	"github.com/fernisoites/k8s-controller-demo/pkg/generated/clientset/versioned/scheme"
...
// FooV1Client is used to interact with features provided by the foo.fernisoites.io group.
type FooV1Client struct {
	restClient rest.Interface
}

func (c *FooV1Client) Foos(namespace string) FooInterface {
