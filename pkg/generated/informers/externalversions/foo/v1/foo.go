...
import (
	...
	internalinterfaces "github.com/fernisoites/k8s-controller-demo/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/fernisoites/k8s-controller-demo/pkg/generated/listers/foo/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.FooV1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FooV1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&foov1.Foo{},
		resyncPeriod,
